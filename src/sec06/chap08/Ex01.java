...
public class Ex01 {
    public static void main(String[] args) {
        ...
        int largerInt = Math.max(2, 3); // 제일 큰 수 반환
        float smallerFlt = Math.min(1.2f, 3.4f); // 제일 작은 수 반환
        ...
        BigInteger bigInt1 = new BigInteger("123456789012345678901234567890"); // 문자 입력시 오류
        ...
        //  부동소수점 오차, 부동소수점은 2진법의 부동소수점 알고리즘으로 계산을 하기 때문에 10진법으로 나타내면 오류가 난다.
        var num1 = 0.2 + 0.3f;
        var num2 = 0.3f * 0.7f;
        var num3 = 0.4 - 0.3;
        var num4 = 0.9f / 0.3;
